...
public class DisableItem extends Item{
	...
	public static ItemStack recoverItemStack(ItemStack stack){
		...
		stack=ItemStack.loadItemStackFromNBT((NBTTagCompound) stack.stackTagCompound.getTag("ItemStack"));
...
//	}
    ...
    private IIcon getStoredIcon(ItemStack stack){
    	...
    	return thisStack.getItem().getIconFromDamage(thisStack.getItemDamage());
    	}else return null;
    }
